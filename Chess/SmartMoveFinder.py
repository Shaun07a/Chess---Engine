            ...
            if square != "--":
                ...
                if square[1] != "K": #no position table for king
                    if square[1] ==  "p": #for pawns
                        piecePosScore = piecePositionScore[square][row][col]
                    else: #for other pieces
                        piecePosScore = piecePositionScore[square[1]][row][col]
                if square[0] == 'w':
                    score += pieceScore[square[1]] + piecePosScore * .1
                elif square[0] == 'b':
                    score -= pieceScore[square[1]] + piecePosScore * .1
